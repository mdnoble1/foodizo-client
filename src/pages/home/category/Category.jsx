  ...
  return (
    <section className="w-11/12 mx-auto my-16">
      ...
      <div ref={sliderRef} className="keen-slider py-6">
        {/* slide1  */}
        <div className="keen-slider__slide number-slide1 relative h-min cursor-pointer">
        ...
        {/* slide2  */}
        <div className="keen-slider__slide number-slide2 relative h-min cursor-pointer">
        ...
        {/* slide3  */}
        <div className="keen-slider__slide number-slide3 relative h-min cursor-pointer">
        ...
        {/* slide4  */}
        <div className="keen-slider__slide number-slide4 relative h-min cursor-pointer">
        ...
        {/* slide5  */}
        <div className="keen-slider__slide number-slide5 relative h-min cursor-pointer">
        ...
        {/* slide6  */}
        <div className="keen-slider__slide number-slide6 relative h-min cursor-pointer">
